  ...
  return (
    ...
    >
      ...
      <div style={{ display: 'flex', justifyContent: 'center' }}>
          {data.output ? (
               <div style={{ position: 'relative', width: '100%', height: 120, border: '1px solid #e5e6eb', borderRadius: 4, overflow: 'hidden', background: '#000', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
                  <video src={data.output} style={{ width: '100%', height: '100%', objectFit: 'contain' }} />
                  <Button 
                    size="mini" 
                    status="danger" 
                    shape="circle" 
              ...
              >
                  <div style={{ 
                      ...
                      <span style={{ fontSize: 12 }}>Upload Video</span>
                  </div>
              </Upload>
          )}
      </div>
