...
:::warning Note
Seedance 2.0 is currently available only via the [Model Playground](https://console.byteplus.com/ark/region:ark+ap-southeast-1/experience/vision?modelId=doubao-seedance-2-0-260128&tab=GenVideo) within the free quota and does not support API invocation at this time. Please stay tuned for updates.
