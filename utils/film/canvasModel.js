...
export const serializeNodes = (nodes) => {
  ...
  return [...parentless, ...children].map((n) => {
    ...
    const { localUrl, loading, preserving, busy, shooting, storyboarding, casting, boarding, splitting, developing, projecting, endLoading, authorPending, enhancePhase, phase, ...persistData } = n.data || {};
    return {
      id: n.id,
      type: n.type,
      position: n.position,
